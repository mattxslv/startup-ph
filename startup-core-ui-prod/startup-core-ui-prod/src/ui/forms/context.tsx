...
import { FormikValues, FormikErrors, FormikTouched, FormikState, FieldInputProps, FieldMetaProps, FieldHelperProps } from 'formik'

export interface IFormik<Values extends FormikValues = FormikValues> {
...
export const FormContext = createContext<IFormik<any> | null>(null)
