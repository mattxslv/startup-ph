...
<?php $__env->startSection('content'); ?>
    ...
    <p style="line-height: 140%">We have received your request to reset the password for your Startup PH account. To ensure the security of your account, we have generated a One-Time Password (OTP) that you can use to reset your password.</p>
...
<?php echo $__env->make('mail/mail-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/mail/reset-password-mail.blade.php ENDPATH**/ ?>