...
import { IResources } from './useResources';
...
function ResourcesCard({ truncateTitle = false, data }: Props) {
  return (
...
function ResourcesCardHorizontal({ data }: Props) {
  return (
    <div className='flex'>
      <div className='pr-4'>
...
export { ResourcesCardHorizontal };
