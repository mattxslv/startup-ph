...
import Modal, { IModalConfig } from './Modal'
...
function reducer(state: Record<string, IModal>, action: { type: string, data: Partial<IModal> }) {
  switch (action.type) {
    case 'APPEND':
    ...
    return (
      <ModalContext.Provider value={value}>
        ...
        {Object.keys(state).map((key) => {
          ...
          return (
            <Modal key={key} {...rest} onClose={() => dispatch({ type: 'OMIT', data: { id: key } })}>
